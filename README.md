...
Open each file exactly as written, format JSON only when requested, and show an optional Markdown preview. Sic uses native document windows, file dialogs, Undo/Redo, and Find. Files stay on your Mac.
...
Download [Sic 0.2.0](https://github.com/iamjason/sic-site/releases/download/v0.2.0/Sic-0.2.0.zip), unzip it, and drag Sic.app to Applications. A [SHA-256 checksum](https://github.com/iamjason/sic-site/releases/download/v0.2.0/Sic-0.2.0.zip.sha256) accompanies the release.
